        ...
        <section id='projects' className='py-32 relative overflow-hidden'>
            ...
            <div className='container mx-auto px-6 relative z-10'>
                        ...
                        <div key={idx} className='group glass rounded-2xl overflow-hidden animate-fade-in md:row-span-1' style={{animationDelay: `${(idx + 1) * 100}ms`}}>
                            ...
                            <div className='relative overflow-hidden aspect-video'>
                                ...
                                <div className='absolute inset-0 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
                                    <a href={project.link} className='glass rounded-full p-3 hover:bg-primary hover:text-primary-foreground transition-all'>
                                        <ArrowUpRight className='w-5 h-5'/>
                                    </a>
                                    <a href={project.github} className='glass rounded-full p-3 hover:bg-primary hover:text-primary-foreground transition-all'>
                ...
                <div className='text-center mt-12 animate-fade-in animation-delay-500'>
                    <AnimatedBorderButton handleClick={() => window.open('https://github.com/faris21dev?tab=repositories', '_blank')}>
                        View All Projects
                        <ArrowUpRight className='w-5 h-5'/>
